        ...
        <div class="page-content">
            ...
            <div class="page-header no-margin-bottom">
                <div class="container-fluid">
                    <h2 class="h5 no-margin-bottom">Actualizacion de Ingresos</h2>
                </div>
            </div>
            <!-- Breadcrumb-->
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Actualizar Ingreso</li>
                </ul>
            </div>
            <section class="no-padding-top">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="block">
                                <div class="title"><strong>Actualización del Ingreso N# <?php echo $id; ?></strong></div>
                                <div class="block-body">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}"); ?>" method="POST">
                                        <div class="form-group">
                                            <?php ingresoaActualizar($id); ?>
                                            <?php ActualizarIngreso($id); ?>    
                                            <input type='submit' value='Actualizar Ingreso' class='btn btn-primary' />
                                            <a href='listarIngresos.php' class='btn btn-info'>Volver al Listado</a>
                                        </div>
                                        </fieldset>
                                        <br><br>
                                    </form>
